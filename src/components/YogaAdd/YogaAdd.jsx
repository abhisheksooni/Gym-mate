...
function YogaAdd({img="bg2", h, p, span, pp, className, btntext}) {
  return (
    <div className={` ${"bg-"+img}  bg-no-repeat-y w-full  uppercase text-text1 flex flex-col items-center p-6 py-16 my-12 ${className}`}>
