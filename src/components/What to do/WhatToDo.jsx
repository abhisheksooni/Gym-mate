...
function WhatToDo({text, className}) {
  return (
    <div className={` flex items-center text-center xl:text-start justify-center flex-wrap gap-6 m-5 ${className}`}>
        <div className=" lg:w-[35rem]">
            <p className=' text-[48px]'>{text? "":"All About"}</p>
