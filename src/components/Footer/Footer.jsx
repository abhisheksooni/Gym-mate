...
function Footer() {
  return (
    ...
    <section className=' flex justify-evenly flex-col px-5 items-center lg:flex-row lg:items-start '>
<div className="max-w-[450px] *:mb-4 flex flex-col items-center text-center lg:items-start lg:text-start">
   ...
   <ul className='flex gap-4 *:rounded-full *:p-2  hover:*:bg-red hover:*:text-[#fff] hover:*:cursor-pointer'>
    <li><Facebook/></li>
    <li><Instagram/></li>
    <li><Twitter/></li>
    <li><Youtube/></li>
...
<ul className=' *:mb-2 hover:*:text-red hover:*:cursor-pointer'>
    <p className='font-extrabold mb-4 text-2xl'>Our Classes</p>
...
<ul className=' *:mb-2 '>
    <p className='font-extrabold mb-4 text-2xl'>Working Hours</p>
